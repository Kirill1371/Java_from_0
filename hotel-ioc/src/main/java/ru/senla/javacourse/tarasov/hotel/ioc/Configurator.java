...
import ru.senla.javacourse.tarasov.hotel.ioc.annotations.ConfigProperty;
...
public class Configurator {
    ...
    private static Properties loadProperties(String configFileName) {
        ...
        try (InputStream input = new FileInputStream("C:/Users/Kirill/IdeaProjects/Test/src/main/java/com/test/resources/database/database.properties")) {
            if (input == null) {
